#ifndef _VYT_INST_IMUL_H
#define _VYT_INST_IMUL_H
#include <stdint.h>
#include "../vyt.h"
#include "../exec.h"

static inline int VINST_imul(vproc *proc, vthrd *thr, vbyte wsz, vbyte mop1, vbyte op1sz, vbyte *op1, vbyte mop2, vbyte op2sz, vbyte *op2) {
